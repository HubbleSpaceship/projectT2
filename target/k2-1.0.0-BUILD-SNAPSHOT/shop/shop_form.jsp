...
<section>
 ...
 <tr><td> 아이디 </td><td><input  type="text" name="id" id = "id" required>
 <input type = "button" value ="중복 확인" id ="check"> </td> </tr>
 ...
 <tr><td>도시코드 </td><td><input  type="text" name="city" size=10> </td> </tr>
